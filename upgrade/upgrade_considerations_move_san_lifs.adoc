...
For more information, see the https://docs.netapp.com/us-en/ontap/san-admin/move-san-lifs-task.html[move a SAN LIF^] procedure in the _SAN storage management_ documentation.
