...
This content does not describe how to use aggregate relocation (ARL) to upgrade controller hardware, which is described in the link:upgrade-arl/index.html[ARL controller hardware upgrade^] content.
