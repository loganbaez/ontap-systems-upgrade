...
You must have reviewed xref:upgrade_considerations.adoc[Considerations for upgrading controller hardware] about converting a node to a drive shelf. You should contact technical support if you need guidance specific to your configuration.
