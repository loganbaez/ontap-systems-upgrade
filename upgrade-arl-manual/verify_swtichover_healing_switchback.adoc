...
Refer to link:other_references.html[References] to link to the _MetroCluster Management and Disaster Recovery Guide_ and follow the procedures for negotiated switchover, healing, and switchback.
