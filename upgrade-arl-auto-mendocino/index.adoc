...
[.lead]
*You can use this aggregate relocation procedure to upgrade an AAF A700 to an AAF A900 system by using "system controller replace" commands. This procedure applies to AFF A700 and AFF A900 systems running ONTAP 9.10.1 or later.*
