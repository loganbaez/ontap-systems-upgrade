...
summary: After swapping the corresponding AFF A900 node2 controller module and NVS, you might need to netboot them.
---
...
.	If necessary, set the partner system ID on node2:
+
NOTE: This is the system ID of the node1 that you are upgrading to an AFF A900.
+
