---
sidebar: sidebar
permalink: upgrade-arl-auto-mendocino/overview-of-the-arl-upgrade.html
...
|Stage 2. Relocate resources from node1 and retire the AFF A700 node1
...
.	Install AFF A900 NVS and controller module on node1
.	Netboot node 1
...
a| .	Install AFF A900 NVS and controller module on node2.
.	Netboot node2
