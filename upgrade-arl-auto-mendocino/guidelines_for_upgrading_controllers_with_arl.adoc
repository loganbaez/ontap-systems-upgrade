...
[.lead]
Using ARL to upgrade a pair of AFF A700 controllers running ONTAP 9.10.1 or later to an AFF A900 depends on the system and the configuration of both the original and replacement controllers.
