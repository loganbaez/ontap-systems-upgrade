...
|link:https://docs.netapp.com/us-en/ontap-sm-classic/online-help-96-97/concept_managing_network.html[ONTAP 9 Network Management Guide for 9.7 and Earlier^]
